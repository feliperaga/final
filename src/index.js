...
// sqlite3 -csv -header movies.sqlite3 'select "imdbID" as id, "title", "year", "rating", "runtime", "genre", "released", "director", "writer", "cast", "metacritic", "imdbRating", "imdbVotes", "poster", "plot", "language", "country", "awards" from movies' | csvtojson --maxRowLength=0 > movies.json
// Firebase configuration
var Rebase = require('re-base')
var base = Rebase.createClass({
  apiKey: "AIzaSyDVhN--2nn6e470Tplrtk4WZOKyyBhG4Gg",   // replace with your Firebase application's API key
  databaseURL: "https://buyflix-final-65b29.firebaseio.com/", // replace with your Firebase application's database URL
})
